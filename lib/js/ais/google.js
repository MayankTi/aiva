...
// 2. https://developers.google.com/apis-explorer/#p/
// 
// Setup:
// 1. Create a Google Developer account https://console.developers.google.com/
// 2. Create a project, then generate an API key (server key) https://console.developers.google.com/apis/credentials
// 3. Enable the APIs you wish to use https://console.developers.google.com/apis/enabled
// 4. moreover you may wish to set a consent screen and create OAuth credentials for certain APIs that's that reaches into your private information, e.g. gmail API
...
Promise.promisifyAll(nearbyPlaces);
/*
var nearby = function(latitude, longitude, next) {
